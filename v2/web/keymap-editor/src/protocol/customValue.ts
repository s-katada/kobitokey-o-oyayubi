 ...
 * and are **not persisted**: every reboot reloads the defaults baked
 * into the static initialisers. See the "Persistence" note in
 * `v2/firmware/rmk/src/config.rs`. The UI must say so rather than imply
